...
function! myspacevim#before()
  try
    ...
    let g:coc_global_extensions = [
          ...
          \ 'coc-post', 'coc-prettier', 'coc-project', 'coc-protobuf', 'coc-pyright',
          \ 'coc-react-refactor', 'coc-rust-analyzer',
          \ 'coc-snippets', 'coc-sh', 'coc-sql', 'coc-stylelint',
          \ 'coc-tsserver', 'coc-todolist', 'coc-toml', 'coc-tailwindcss', 'coc-translator',
